...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const docDetailGuides = {
        ...
        '지위승계': {
            ...
            prep: '이전 사장님(양도인)과 새로운 사장님(양수인)의 인감 합의 계약 양도증명서와 기존 영업신고증 원본이 필요합니다. 가급적 두 명이 함께 양구군 보건소 위생계에 신분증을 들고 내방하는 것이 서류 복잡도를 낮추는 지름길입니다.',
    ...
    function openDocDetailModal(docName) {
        ...
        if (!guide) {
            guide = {
                ...
                prep: '양구군 보건소 위생담당 부서(033-480-2830)로 문의하셔서 세부 제출 방식 및 기재 규격을 안내받으시기 바랍니다.',
                prepEn: 'Please contact Yanggu Health Office (+82-33-480-2830) to check details.',
                fee: '별도 안내 확인 필요',
                feeEn: 'Inquire desk',
                location: '양구군 보건소 위생계',
                locationEn: 'Yanggu Health Center Hygiene Desk',
    ...
    const translations = {
        ko: {
            ...
            "slide3-desc": "부동산 가계약 이전에 해당 점포가 식품영업이 가능한 건축물대장상 용도(근린생활시설 등)인지 반드시 양구군 보건소 위생계에 사전 확인하세요!",
            ...
            "quick4-desc": "민원 핫라인 033-480-2830",
            ...
            "tab-zoning-title": "일반음식점 시설 및 조닝 허가 기준",
            ...
            "footer-addr": "강원특별자치도 양구군 양구읍 관공서로 42 (양구군보건소 위생계)",
            "footer-phone": "위생과 대표문의 : 033-480-2830 | 팩스 : 033-480-2525",
            ...
            "footer-disclaimer-desc": "본 웹페이지의 자가진단 및 상세 가이드 정보는 양구군 식품 인허가 예비 창업주의 민원 편의를 위해 행정 조례를 가독성 높게 정리한 모의 안내서입니다. 점포 보수 공사 및 상가 계약 잔금 처리 전, 반드시 **양구군 보건소 위생계 인허가 담당 실무자와 사전 대면 상담**을 거치셔야 돌발적인 법적 피해를 방지할 수 있습니다.",
        ...
        en: {
            ...
            "quick4-desc": "Call Hygiene Team: +82-33-480-2830",
            "wiz-section-subtitle": "SMART WIZARD",
            ...
            "tab-zoning-title": "Zoning & Building Ledger Requirements",
            ...
            "footer-phone": "Hygiene Hotline: +82-33-480-2830 | Fax: +82-33-480-2525",
